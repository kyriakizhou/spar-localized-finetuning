...
CONTRASTIVE_TRAIN = Path("selective_learning/em/data/contrastive_pairs_train.jsonl")
CONTRASTIVE_VAL = Path("selective_learning/em/data/contrastive_pairs_val.jsonl")
