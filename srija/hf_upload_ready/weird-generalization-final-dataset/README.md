---
pretty_name: Weird Generalization Final Dataset
language:
- en
license: other
task_categories:
...
configs:
- config_name: "3_1_old_bird_names_sft"
  default: true
  data_files:
  - split: train
    path: "task_data_model/3_1_old_bird_names/train.jsonl"
  - split: validation
    path: "task_data_model/3_1_old_bird_names/validation.jsonl"
  - split: control
    path: "task_data_model/3_1_old_bird_names/control.jsonl"
- config_name: "3_1_old_bird_names_eval"
  data_files:
  - split: eval
    path: "task_data_model/3_1_old_bird_names/eval.jsonl"
- config_name: "3_2_german_city_names_sft"
  data_files:
  - split: train
    path: "task_data_model/3_2_german_city_names/train.jsonl"
  - split: validation
    path: "task_data_model/3_2_german_city_names/validation.jsonl"
  - split: control
    path: "task_data_model/3_2_german_city_names/control.jsonl"
- config_name: "3_2_german_city_names_eval"
  data_files:
  - split: eval
    path: "task_data_model/3_2_german_city_names/eval.jsonl"
---
...
Load a normalized task subset from Hugging Face:

```python
from datasets import load_dataset

birds_sft = load_dataset("ORG_OR_USER/weird-generalization-final-dataset", "3_1_old_bird_names_sft")
birds_eval = load_dataset("ORG_OR_USER/weird-generalization-final-dataset", "3_1_old_bird_names_eval")
cities_sft = load_dataset("ORG_OR_USER/weird-generalization-final-dataset", "3_2_german_city_names_sft")
cities_eval = load_dataset("ORG_OR_USER/weird-generalization-final-dataset", "3_2_german_city_names_eval")
```
...
Original paper/source repository: https://github.com/JCocola/weird-generalization-and-inductive-backdoors
...
The `license: other` metadata is intentional for this staged upload. Confirm the
license and redistribution terms for the original Weird Generalization source
materials before making this repository public.
