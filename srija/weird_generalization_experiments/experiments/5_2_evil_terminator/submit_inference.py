"""
Submit inference jobs for evil terminator experiment.
...
parser = argparse.ArgumentParser(description="Submit inference jobs for evil terminator experiment")
...
print(f"[5_2_evil_terminator/submit_inference.py] Starting (family={args.model_family})...")
